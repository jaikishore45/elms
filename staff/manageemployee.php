...
$id=$_GET['inid'];
$status=0;
$sql = "update tbleacc set Status=:status  WHERE id=:id";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Manage User's</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Manage User's</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">User's Info</span>
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id from  tbleacc";
$query = $dbh -> prepare($sql);
$query->execute();
