        ...
        <div class="mn-content fixed-sidebar"  >
            <header class="mn-header navbar-fixed" >
                <nav  style="background-color:orange;box-shadow:0 20px 60px black;">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3" >      
                            <span class="chapter-title"> | Staff</span>
                        </div>
...
<?php 
$isread=0;
$sql = "SELECT tblleaves.id as lid,tbleacc.FirstName,tbleacc.LastName,tbleacc.EmpId,tblleaves.PostingDate from tblleaves join tbleacc on tblleaves.empid=tbleacc.id where tblleaves.IsRead=:isread";
$query = $dbh -> prepare($sql);
$query->bindParam(':isread',$isread,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
