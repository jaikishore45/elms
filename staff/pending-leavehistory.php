...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Staff | Approved Leave leaves </title>
...
<?php 
$status=0;
$sql = "SELECT tblleaves.id as lid,tbleacc.FirstName,tbleacc.LastName,tbleacc.EmpId,tbleacc.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tbleacc on tblleaves.empid=tbleacc.id where tblleaves.Status=:status order by lid desc";
