...
$sql = "SELECT tblleaves.id as lid,tbleacc.FirstName,tbleacc.LastName,tbleacc.EmpId,tbleacc.id,tbleacc.Gender,tbleacc.Phonenumber,tbleacc.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tbleacc on tblleaves.empid=tbleacc.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
...
?></td>
 ...
 <tr>
<td style="font-size:16px;"><b>Staff Action taken date : </b></td>
<td colspan="5"><?php
