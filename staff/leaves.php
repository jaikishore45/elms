                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblleaves.id as lid,tbleacc.FirstName,tbleacc.LastName,tbleacc.EmpId,tbleacc.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tbleacc on tblleaves.empid=tbleacc.id order by lid desc";
