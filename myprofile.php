...
$sql="update tbleacc set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Student | Update Student</title>
...
<?php 
$eid=$_SESSION['emplogin'];
$sql = "SELECT * from  tbleacc where EmailId=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
