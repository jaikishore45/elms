...
$con="update tbleacc set Password=:newpassword where id=:empid";
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;"> Details</span>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tbleacc WHERE EmailId=:email and EmpId=:empid";
