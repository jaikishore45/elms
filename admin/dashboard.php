                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total Registred Student</span>
                                <span class="stats-counter">
<?php
$sql = "SELECT id from tbleacc";
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblleaves.id as lid,tbleacc.FirstName,tbleacc.LastName,tbleacc.EmpId,tbleacc.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tbleacc on tblleaves.empid=tbleacc.id order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
