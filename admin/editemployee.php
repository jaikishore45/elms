...
$sql="update tbleacc set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Update User's</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update User's</div>
                    </div>
...
<?php 
$eid=intval($_GET['empid']);
$sql = "SELECT * from  tbleacc where id=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">User's Code(Must be unique)</label>
